...
def main(labelmap_path, model_path, tf_record_path, config_path, output_path):
    ...
    anim = animation.FuncAnimation(f, animate, frames=20, interval=1)
    anim.save(output_path, fps=30, dpi=300, writer='ffmpeg')
...
if __name__ == "__main__": 
    ...
    """main("label_map.pbtxt", "experiments/experiment_0/exported/saved_model",
    "data/val/segment-11925224148023145510_1040_000_1060_000_with_camera_labels.tfrecord",
    "experiments/experiment_0/pipeline_0.config",
    "./animation0.gif")"""
